...
### <a name="diffsplice"></a>flair diffSxp
...
**Usage:**
```sh
python flair.py diffExp -i isoforms.bed|isoforms.psl -q count_matrix.tsv [options]
```

**Inputs:**</br>
(1) `-q` is a tab-delimited bed or psl file generated by the [`flair collapse`](#collapse) module.
