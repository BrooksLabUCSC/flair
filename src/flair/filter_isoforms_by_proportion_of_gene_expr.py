...
def main():
    try:
        ...
        raise ValueError('usage: filter_isoforms_by_proportion_of_gene_expr.py isoforms support_percentage outfile')

    if s >= 1:
        raise ValueError('Support percentage should be a decimal e.g. 0.1 for 10%')
