...
EXTRA_BED_FIELDS = [('string','gene_id',"gene_id from reference gtf file or generated by FLAIR"),
...
class Isoform:
    ...
    def __init__(self, chrom, strand, juncs, start=None, end=None, reads=None, gene_id=None, ref_transcript_id=None):
        self.chrom = chrom
        self.strand = strand
        self.juncs = self._intern_juncs(juncs)
        self.start = start
    ...
    def regroup(cls, iso, newstart=None, newend=None, newreads=[], newstrand=None):
        ...
        return cls(iso.chrom, newstrand, iso.juncs, newstart, newend, newreads, iso.gene_id, iso.ref_transcript_id)
